...
- [ ] 5.5 Confirmar en las métricas de la tabla que `community.post_likes` deja de estar en 0 filas a medida que los usuarios vuelven a dar like (señal de que el flujo real se restituyó, no solo el gate sintético).
