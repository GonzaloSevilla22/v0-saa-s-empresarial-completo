...
-- md5 verificado en checkpoint 1.2: ef2d9459f125c200a28b757d266eb738 (32940 chars). PASA.
-- La reescritura del grupo 5 (tasks.md) parte de ESTE archivo, no del último archivo de
-- migración (regla de la casa desde metodos-pago-operaciones).
