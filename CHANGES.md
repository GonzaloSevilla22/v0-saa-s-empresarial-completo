...
**Change ad-hoc `cuentas-billetera-tipo`** ✅ **COMPLETADA 2026-08-22/23** (PR #447 apply / archive PR pendiente — fuera de la secuencia `v3-*`, pedido directo del PO el mismo día: *"aca deberia haber otra que sea agregar billetera virtual no solo agregar banco para diferenciarlos"*). El dato estrella que confirmó el pedido: de las 8 filas de `bank_accounts` en prod (4 activas + 4 soft-deleted), **8/8 eran billeteras virtuales — 0 bancos reales, 0 con CBU cargado**; el formulario les pedía "Banco" y "CBU" a todas.
