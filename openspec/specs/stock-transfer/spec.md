...
> Capability: **stock-transfer** — transferencia de stock entre sucursales de la misma cuenta. Exclusivo plan PRO. Permite mover inventario entre sucursales de forma atómica mediante la RPC `rpc_transfer_stock`, con trazabilidad completa vía `stock_movements`.
