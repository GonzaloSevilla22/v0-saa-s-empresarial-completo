# branch-decommission-guard — Spec (sucursal-guard-vaciado-auditoria)

## Purpose

Precondición de vaciado para dar de baja una sucursal. Ninguna sucursal puede desactivarse, cerrarse operacionalmente ni borrarse físicamente mientras tenga contenido operativo — existencias distintas de cero en su inventario, una sesión de caja abierta, o transferencias de stock sin completar. La verificación vive en un disparador sobre la propia tabla de sucursales (punto de paso obligado), cubriendo por construcción los cuatro caminos de escritura que existen hoy (comando de desactivación, comando de cierre, actualización directa del backend, escritura directa vía RLS) y cualquiera que se agregue después. El borrado físico de una sucursal está prohibido incondicionalmente, con o sin contenido. Nace del incidente del 22-08-2026: una sucursal con 518 productos se desactivó sin ninguna verificación y dejó el negocio invendible dos días.
