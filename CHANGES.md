...
- **Estado**: 🔨 **PR1-4 mergeados 2026-08-01** (esquema + backend + frontend + correos completos, 38/76 tasks) · **Governance**: CRÍTICO (dinero real) — sign-off PO 2026-07-31 sobre el rumbo + amendment/pivot 2026-08-01; **la palanca `BILLING_SUBSCRIPTIONS_ENABLED` está ON en prod desde el 2026-08-02** (activación real ocurrida sin registro, descubierta y verificada el 27-08 — ver párrafo de incidente abajo y `docs/gates-mercadopago-2026-08-27.md`). §9 sigue con una sola task genuinamente abierta (9.6, primer cobro/conversión orgánica).
...
- **Pendiente**: solo la task 9.6 (primer cobro real/conversión orgánica) queda genuinamente abierta en §9 — el resto se completó o se reinterpretó el 27-29/08 (ver `openspec/changes/mp-real-subscriptions/tasks.md`). **H-19 / `v31-mp-webhook-atomic`** (atomicidad transaccional del webhook) sigue abierto — este change no lo cubre, mismo alcance que `v31-mp-upgrade-webhook-fix`.
...
- **Leer antes**: `openspec/changes/mp-real-subscriptions/design.md` (Amendment + D2bis, D6, D9-D11), `openspec/changes/mp-real-subscriptions/tasks.md`, `v31-mp-upgrade-webhook-fix` (prerequisito duro), `docs/gates-mercadopago-2026-08-27.md` (runbook de activación + incidente).
