...
- **Tarea manual del PO (fuera de código, bloquea el "video visible" pero no el merge)**: crear el canal de YouTube, subir los 5 `.mp4` como *unlisted* y pasar los `youtubeVideoId`.
