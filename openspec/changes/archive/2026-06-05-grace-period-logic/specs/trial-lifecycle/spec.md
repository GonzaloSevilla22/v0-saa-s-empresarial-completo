# trial-lifecycle — Spec (grace-period-logic)

> Capability: **trial-lifecycle** — vencimiento programado del trial, transición de estado, auditoría del downgrade y notificaciones al usuario.
