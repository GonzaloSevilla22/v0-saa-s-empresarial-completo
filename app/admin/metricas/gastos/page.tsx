...
export default async function AdminGastosAnalytics() {
    ...
    const stats = await fetchModuleStats('gastos', dateFrom, dateTo, supabase)
        ...
        <div className="container mx-auto p-6 max-w-7xl">
            <div className="mb-8">
                ...
                <ModuleAnalytics
                    ...
                    subtitle="Distribución de egresos operativos globales"
                    stats={stats}
                    moduleType="gastos"
                />
            </div>
