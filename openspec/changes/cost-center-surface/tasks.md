...
- [x] 7.4 Rama `feat/cost-center-surface` + PR (nunca commit directo a `main`); los checks de CI —incluidos el gate de ACLs y KPI Validation, que es donde corren los gates SQL de esta migración— deben quedar verdes antes de mergear
