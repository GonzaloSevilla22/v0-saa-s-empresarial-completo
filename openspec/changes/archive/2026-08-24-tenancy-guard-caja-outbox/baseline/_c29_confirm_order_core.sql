...
-- md5(pg_get_functiondef) = cecd8c5454611f267a5e131d73bf7928 · length = 15110.
-- prosecdef = true · anon=false · authenticated=true · service_role=true.
-- ESTE es el punto de partida obligatorio de la reescritura de la capa 1 (D1):
-- la ÚNICA diferencia admisible contra la migración nueva es el bloque de
-- guard cash_optin_requires_open_session + sus dos variables + el COMMENT.
