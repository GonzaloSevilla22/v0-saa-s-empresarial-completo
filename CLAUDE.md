...
**`C-27 v21-fiscal-profile`** [CRÍTICO, camino crítico — **requiere PA-22 del PO antes del adaptador AFIP real**: ¿homologación o producción?] o **`C-28 v21-cash-session`** [MEDIO] — ambos desbloqueados por C-26 (archivado 2026-06-12: Branch como Aggregate Root, lifecycle open/close, StockTransfer como entidad, invariante `onHand >= 0`). En paralelo quedan los dos últimos de Fase 6: C-24 (BAJO, insights-unification) y C-25 (MEDIO, outbox-activation).
