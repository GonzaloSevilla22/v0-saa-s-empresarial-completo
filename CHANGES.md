...
- **`banco-y-caja-consolidado`** ⭐ — pedido directo del PO al firmar `delete-guard-ledgers` OQ-3: rediseñar C-28 a "caja siempre abierta" + consolidar Banco y Caja en un módulo unificado — elimina de raíz el escenario "sin sesión abierta" que hoy `P0426` bloquea como interino. Requiere explore/propose propio (toca el modelo de sesiones de caja en producción).
