...
-- capturado 2026-09-01 vía mcp__supabase__execute_sql (SELECT, read-only) durante
-- el checkpoint de integridad de función (task 1.2) de caja-compras-cobranzas.
-- md5:    058f4d291d85bec0ae46589bde49e3a3
-- length: 19438
-- Coincide EXACTO con la tabla de design.md — checkpoint 1.2 PASA, sin divergencia.
-- Esta función SE REESCRIBE en 20261018000001_caja_compras_cobranzas.sql (grupo 3):
-- suma p_cash_session_id uuid DEFAULT NULL trailing + el bloque de opt-in de caja
-- (3 condiciones, copiado literal del de rpc_create_expense).
