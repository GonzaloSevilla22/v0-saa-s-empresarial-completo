 ...
 * SaleOperationsList
 *
 * Renders sales grouped by operation_id.
              ...
              >
                ...
                <div className="flex justify-center">
                  {op.isGrouped ? (
                    <Badge
                      variant="secondary"
                      className="text-[10px] bg-emerald-500/15 text-emerald-400 border-emerald-500/25 border font-semibold"
                    >
                    ...
                    {op.items.map((item) => (
                      ...
                      >
                        ...
                        <span className="text-right text-muted-foreground tabular-nums">
                          {formatMoney(item.unitPrice, op.currency)}
                        </span>
                        <span className="text-right font-semibold text-emerald-400 tabular-nums">
                          {formatMoney(item.total, op.currency)}
                        </span>
                      </div>
                    ))}
