...
-- md5(pg_get_functiondef) = 0b6bcc5b6caa1a3c01e0da16518c7d35 - length = 13914.
-- Rol en el change: REFERENCIA (no se toca): de aca se copian VERBATIM la derivacion de kind desde el catalogo y los 3 predicados del opt-in de caja (D1).
--
