...
- [x] 6.3 QA manual mínimo (idealmente con al menos un `youtubeVideoId` real): en `/` el link "Aprendé a usar ALIADATA" hace scroll a la sección y las cards con video reproducen tras el click (facade); en el dashboard, el botón "Ver tutorial" aparece solo en rutas con tutorial y abre el modal 16:9. Confirmar que la landing below-the-fold no penaliza el LCP. — **COMPLETADO**: QA prod 2026-07-29 por orquestador: reproducción embebida verificada, 0 violaciones CSP.
