...
export default function AdminVentasAnalytics() {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            setError(err.message || "Error al cargar las analíticas de ventas.")
        } finally {
            setLoading(false)
        }
    }
    ...
    if (error || !stats) return (
        <div className="flex flex-col items-center justify-center py-32 gap-6 container max-w-md text-center">
            ...
            <div className="space-y-2">
                ...
                <p className="text-slate-400 text-sm">{error || "No se pudieron obtener los datos de ventas."}</p>
            </div>
    ...
    return (
        <div className="container mx-auto p-6 max-w-7xl">
            <div className="mb-8">
                ...
                <ModuleAnalytics title="Analíticas de Ventas" subtitle="Rendimiento comercial global de todos los emprendedores" stats={stats} moduleType="ventas" />
            </div>
        </div>
    )
}
