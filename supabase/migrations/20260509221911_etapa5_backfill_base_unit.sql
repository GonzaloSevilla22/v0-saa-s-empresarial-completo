...
-- DESCRIPTION: DB-level guard trigger ensuring untracked products
--              (stock_control_type = 'untracked') never have their stock
--              decremented on sales or incremented on purchases.
--              The RPC already checks stock_control_type; this is a second
--              layer of defence for direct INSERT/UPDATE paths.
--
