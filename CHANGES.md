...
- **Candidato vivo restante**: `cobranzas-catalogo-pagos` (Non-Goal 3 de `caja-compras-cobranzas`) — unificar los modales de cobro/pago al catálogo `payment_methods` completo, espejo de lo que `pos-catalogo-pagos` ya hizo para el mostrador.
