...
| `rpc_delete_expense(uuid)` — capturado en el apply (2026-08-31) porque la task 16.2 exige el motivo también en las reversas del borrado | `819bd69422dfec39dceea76148a7634c` | — | `20261015000001_gastos_forma_pago.sql` | **NO** (md5 prod == md5 local, verificado vía MCP el 2026-08-31) |
