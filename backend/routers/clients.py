...
async def list_clients(
    ...
    return await client_service.list_clients(repo, auth)
...
async def get_client(
    ...
    return await client_service.get_client(repo, auth, client_id)
...
async def create_client(
    ...
    return await client_service.create_client(repo, auth, payload)
...
async def update_client(
    ...
    return await client_service.update_client(repo, auth, client_id, payload)
...
async def delete_client(
    ...
    await client_service.delete_client(repo, auth, client_id)
