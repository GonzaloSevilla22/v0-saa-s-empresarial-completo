...
-- MAX(supabase_migrations.schema_migrations.version) en el momento de captura: 20260930000001.
-- Fuente de verdad anti-regresión-julio (design.md D2/D9): NUNCA reescribir desde el repo.
