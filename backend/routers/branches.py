...
async def list_branches(
    ...
    return await branch_service.list_branches(repo, auth)
...
async def get_branch(
    ...
    return await branch_service.get_branch(repo, auth, branch_id)
...
async def create_branch(
    ...
    return await branch_service.create_branch(repo, auth, payload)
...
async def update_branch(
    ...
    return await branch_service.update_branch(repo, auth, branch_id, payload)
