...
export default async function AdminClientesAnalytics() {
    ...
    const stats = await fetchModuleStats('clientes', dateFrom, dateTo, supabase)
        ...
        <div className="container mx-auto p-6 max-w-7xl">
            <div className="mb-8">
                ...
                <ModuleAnalytics
                    ...
                    subtitle="Análisis de la base de usuarios global"
                    stats={stats}
                    moduleType="clientes"
                />
            </div>
