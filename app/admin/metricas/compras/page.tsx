...
export default function AdminComprasAnalytics() {
    ...
    useEffect(() => {
        async function load() {
            ...
            const data = await fetchModuleStats('compras', dateFrom, dateTo)
            setStats(data)
            setLoading(false)
        }
    ...
    return (
        <div className="container mx-auto p-6 max-w-7xl">
            <div className="mb-8">
                ...
                <ModuleAnalytics title="Analíticas de Compras" subtitle="Abastecimiento y reposición global" stats={stats} moduleType="compras" />
            </div>
        </div>
    )
}
