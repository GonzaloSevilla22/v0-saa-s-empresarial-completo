...
El refresh SHALL cubrir los temas claro y oscuro (ya soportados por `next-themes`), garantizando que todos los tokens semánticos introducidos tengan valor válido en ambos temas y no rompan el contraste WCAG AA que verifica `v4-frontend-04`.
