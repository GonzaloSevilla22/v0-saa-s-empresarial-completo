...
class ExpenseRepository(BaseRepository):
    ...
    async def get_by_id(self, expense_id: str, user_id: str) -> asyncpg.Record | None:
    ...
    async def update(self, expense_id: str, user_id: str, data: dict) -> asyncpg.Record | None:
        ...
        return await self.fetchrow(
            f"UPDATE expenses SET {set_clauses} WHERE id = $1 AND user_id = $2 RETURNING *",
            expense_id,
            user_id,
            *values,
        )

    async def delete(self, expense_id: str, user_id: str) -> str:
