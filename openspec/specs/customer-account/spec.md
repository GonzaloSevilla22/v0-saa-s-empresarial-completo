...
- **Helpers**: `c30_register_customer_account_movement` (REVOKE de PUBLIC), `c30_get_or_create_customer_account` (lazy auto-create idempotente vía ON CONFLICT)
- **RPCs**: `rpc_create_customer_account`, `rpc_register_payment_received` — ambos SECURITY DEFINER, REVOKE de PUBLIC/anon + GRANT a authenticated
