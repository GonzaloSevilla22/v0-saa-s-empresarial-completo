...
## Purpose
Ledger append-only de movimientos bancarios (`BankMovement`): helper intra-tx reutilizable, RPC de carga manual, taxonomía de tipos, RLS por `account_id` denormalizado, e invariante "C1 no postea al journal contable". Entregado en `bank-account-ledger` (V2.5 #3, BankReconciliation C1/3, 2026-06-27).
## Requirements
