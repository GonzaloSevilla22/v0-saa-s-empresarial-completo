# supplier-directory Specification

> Synced from change `compras-proveedor-cuenta-corriente` — 2026-08-23

## Purpose

Maestro de proveedores (`suppliers`) con identidad fiscal compartida (`FiscalIdentity` VO con `clients`), ABM REST en backend Python, pantalla de proveedores con acceso a su cuenta corriente, selector en el formulario de compra con alta inline, y límite de proveedores por plan enforceable en la base de datos.
