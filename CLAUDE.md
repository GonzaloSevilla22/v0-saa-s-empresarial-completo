...
**`C-27 v21-fiscal-profile`** [CRÍTICO, camino crítico — **PA-22 ✅ resuelta 2026-06-12**: adaptador AFIP contra **homologación** de ARCA, ambiente como config por cuenta, trámites de producción en paralelo (`knowledge-base/10` §PA-22)] o **`C-28 v21-cash-session`** [MEDIO] — ambos desbloqueados por C-26 (archivado 2026-06-12: Branch como Aggregate Root, lifecycle open/close, StockTransfer como entidad, invariante `onHand >= 0`). En paralelo quedan los dos últimos de Fase 6: C-24 (BAJO, insights-unification) y C-25 (MEDIO, outbox-activation).
...
| 7 — V2.1 Operación | C-26 → C-30 | 🔨 C-26 ✅ | Branch como root (C-26 ✅: lifecycle + StockTransfer + invariante onHand ≥ 0), FiscalProfile + AFIP (CAE async), CashSession con arqueo, Quote/SalesOrder + quickSale POS, cuentas corrientes |
