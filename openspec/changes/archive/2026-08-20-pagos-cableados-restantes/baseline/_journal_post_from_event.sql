...
-- HALLAZGO (ver commit/PR): PurchaseCreated NO tiene predicado v_is_bank hoy —
-- solo rama cash vs. resto (2100 Proveedores). El wallet→1110 de D7/OQ-1 se
-- implementa en las 3 ramas que SÍ tienen v_is_bank (SaleConfirmed,
-- PaymentReceived, PaymentMade); PurchaseCreated queda sin tocar su
-- estructura de ruteo (fuera de alcance — ver Impact/Non-Goals: bank_movements
-- para transfer/card en compras es OQ-A de pos-catalogo-pagos, abierta).
