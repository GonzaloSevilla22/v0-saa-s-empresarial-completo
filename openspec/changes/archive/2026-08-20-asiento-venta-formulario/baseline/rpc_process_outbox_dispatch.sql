...
-- No forma parte de las tres funciones "oficiales" del propose, pero task
-- 2.7/4.2 le agregan SaleOperationCreated/SaleOperationAdjusted al filtro
-- del Consumer 3 — se guarda igual por la misma disciplina de baseline.
