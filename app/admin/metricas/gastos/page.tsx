...
export default function AdminGastosAnalytics() {
    ...
    useEffect(() => {
        async function load() {
            ...
            const data = await fetchModuleStats('gastos', dateFrom, dateTo)
            setStats(data)
            setLoading(false)
        }
    ...
    return (
        <div className="container mx-auto p-6 max-w-7xl">
            <div className="mb-8">
                ...
                <ModuleAnalytics title="Analíticas de Gastos" subtitle="Distribución de egresos operativos globales" stats={stats} moduleType="gastos" />
            </div>
        </div>
    )
}
