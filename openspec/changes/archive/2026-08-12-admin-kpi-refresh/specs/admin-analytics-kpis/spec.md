...
La columna legacy de plan del perfil no la escribe el motor de billing y hoy vale `pro` en la totalidad de los perfiles de producción, de modo que el MRR reportado y la tasa de conversión son ficciones: la cifra publicada corresponde a treinta y cinco cuentas cuando existe una sola cuenta paga real. El precio no se hardcodea: vive en la tabla de límites de plan, en pesos argentinos, para los cuatro tiers. Este requirement está gateado por el sign-off del PO (OQ-4).
...
La visión del producto define la retención como seguir operando a los treinta días o más, mientras que el motor vigente sólo considera retenido a quien operó entre el día treinta y el treinta y siete, y la pregunta abierta PA-07 registra la discrepancia. Un horizonte abierto haría subir la retención de las cohortes viejas por el solo paso del tiempo y las volvería incomparables entre sí. Este requirement está gateado por el sign-off del PO (OQ-5) y su resolución cierra PA-07.
