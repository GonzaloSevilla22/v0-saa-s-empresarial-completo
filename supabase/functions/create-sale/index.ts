...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { client_id, product_id, amount, quantity, unit_id, currency, operation_id, date } = payload
    ...
    console.log(`6. Executing RPC public.rpc_atomic_create_sale...`)
    ...
    if (operation_id && sale?.id) {
      console.log(`8a. Tagging sale ${sale.id} with operation_id ${operation_id}`)
    ...
    console.log('8. SUCCESS: Sale ID', sale.id)
