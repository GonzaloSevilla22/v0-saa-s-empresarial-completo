...
Ni `sucursal-guard-vaciado-auditoria` (ítem 12) ni los dos changes de tenancy (ítems 13 y 14) dejaron un change propio recomendado como "siguiente" — el gating real sigue siendo `v3-rbac-multirole` (ítem 4, CRÍTICO, bloqueado a sign-off del PO; su dependencia `v31-tenancy-pool-rls` ya está **satisfecha**). Lo que sí quedó documentado y sin resolver:
