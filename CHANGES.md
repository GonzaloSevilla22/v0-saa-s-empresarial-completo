...
- `gastos-forma-pago` (OQ-4 de `pos-banco-movimientos`) — extender el catálogo `payment_methods` a `expenses` para que los gastos por transferencia también escriban `bank_movement`; diferido hasta que `expenses` tenga imputación de forma de pago.
