-- =============================================================================
-- MIGRATION: rpc_amount_guard
-- Patches both aggregate RPCs with:
--   1. amount > 0 validation per item (main fix — prevents negative financial records)
--   2. p_items array length cap at 500 (prevents lock-amplification DoS)
--
-- Both functions are re-created with CREATE OR REPLACE; all other logic is
-- identical to the previous version in 20260528162050_rpc_create_operation_aggregate.sql.
-- =============================================================================
