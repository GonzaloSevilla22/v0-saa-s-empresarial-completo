...
-- md5(pg_get_functiondef) = b46e4c8c2780e28affc280953cc20310 - length = 26592.
-- Rol en el change: REFERENCIA (no se toca): de aca salen los guards P0423 de inmutabilidad y el contrato tri-estado (p_<campo> / p_<campo>_provided) (D11, D12).
--
