...
-- md5:    3af320ebaf30a94eaa7bbf8e3cd05404
-- length: 7031
-- Coincide EXACTO con design.md — checkpoint 1.2 PASA.
-- SE REESCRIBE (grupo 4): suma p_cash_session_id uuid DEFAULT NULL trailing,
-- DROP de la firma anterior (6 args) + CREATE de la nueva (7 args), y la
-- rama cash + sesión informada postea c28_register_cash_movement dentro del
-- bloque protegido por idempotencia. También suma payment_method persistido
-- si OQ-1 se confirma (confirmado: SÍ).
